...
public:
                      ...
                      const std::string& target)
    {
        ...
        logFile << now << " " << operation << " " << directory << " " << target << "\n";
        logFile.flush();
    }
    ...
    void printLog() {
        ...
        std::cout << "\n=== WAL LOG ===\n";
        std::string line;
        while (std::getline(reader, line)) std::cout << line << "\n";
        std::cout << "===============\n\n";
    ...
    void printLogFormatted() {
        ...
        if (lines.empty()) { std::cout << "[WAL] Log is empty.\n"; return; }
    ...
    // ✅ walcount — Count operations by type
    ...
    // ✅ waluncommitted — Show operations without a COMMIT
